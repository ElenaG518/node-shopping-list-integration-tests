...
describe("Recipes List", function() {
  ...
  it("should add an item on POST", function() {
    const newItem = { name: "cereal", ingredients: ["cheerios", "milk", "blueberries"] };
    return chai
      .request(app)
      .post("/recipes")
      .send(newItem)
  ...
  //  3. add the `id` to `updateRecipe`
  //  4. Make a PUT request with `updateRecipe`
  ...
  it("should update items on PUT", function() {
    ...
    const updateRecipe = {
      name: "frijolitos",
      ingredients: ["black beans", "salt", "onion", "water", "serrano pepper"]
    };
